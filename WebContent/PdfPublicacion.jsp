                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h1 text-gray-900 mb-4"><b>PDF Publicación</b></h1>
                                <hr class="bg-dark w-100 ml-0">
                                
                                
                            </div>
                            <div id="foto" class="panel">
								<form class="form" name="frm-pdf" method="post" action="./Sl_PdfPublicacion" enctype="multipart/form-data">
								<%
									int idPublicacion = 0;
								...
								<br>
								<div >
								<%if(post.getMultimedia2()!=null){%>
								<div class="embed-responsive embed-responsive-21by9">
								<iframe src="<%=post.getMultimedia2()%>"></iframe>	
								</div>
								<%}else{%>
								<div class="container" align="center">
								<img id="PDf" class="img-fluid" src="img/pdf.svg"  alt="PDF"
											style="width: 300px; height: 200px; border-bottom-color: white; margin: 2px;" />
								</div>
								<%}%>																
								</div>	
								<br>							 
								<input type="file" id="pdf" name="pdf" onchange="Test.UpdatePreview(this)" accept="file/pdf" required="required" >&nbsp; 
