                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h1 text-gray-900 mb-4">Foto Publicación</h1>
                            </div>
                            <div id="foto" class="panel">
								<form class="form" name="frm-foto" method="post" action="./Sl_ImagenPublicacion" enctype="multipart/form-data">
								<%
									int idPublicacion = 0;
								...
								<div class="container" align="center">
									<img id="preview" class="img-fluid"src="<%=post.getMultimedia1()==null?"img/Defecto.jpeg":post.getMultimedia1()%>" name="preview"  alt="Imagen Publicación"
										style="width: 400px; height: 300px; border-bottom-color: white; margin: 2px;"" />
								</div>
								<br>		
